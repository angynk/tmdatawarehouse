...
public class ConsultaBasicaDEF {
    ...
    public static int EXP_FIN = 4;
    public static int EXP_A = 5;
    public static int EXP_DUR = 6;
    public static int EXP_BUS = 7;
    public static int EXP_LINEA = 8;
    public static int EXP_KM = 9;
    public static int EXP_INFERIDO = 10;
    public static int EXP_ID = 11;
    public static int EXP_FREC = 12;
    public static int EXP_SERBUS = 13;
    public static int EXP_DESA = 14;
    public static int EXP_DESB = 15;
